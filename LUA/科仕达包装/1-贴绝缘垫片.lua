RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9= {}

local tool_name = 'DLObjDetect1'  -- 需访问的工具名
local class_name = '绝缘垫片'  -- 需检测的类别名
local required_count = 20    -- 需要累计的总数
local total_count = 0         -- 累计总数

local overlap_threshold=0.1 -- 交并比阈值

--固定ROI区域
local ROI_Region={left=78,bottom=265,right=142,top=231}

--初始化函数（初始化历史记录）
function RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9.setup(this, ctx)
    total_count = 0
end
...
--执行函数
function RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9.exec(this, ctx)
...
function RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9.cleanup(this, ctx)
    total_count = 0
end

function RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9.on_process_begin(this, ctx)
    total_count = 0
end

function RunScript_a4c6265c_84f9_48ea_9a50_cef11aaa22f9.on_process_end(this, ctx)
    total_count = 0
end
