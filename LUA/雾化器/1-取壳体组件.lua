RunScript_237fb72169744185a6a8ad1f8e491830= {}

local tool_name = 'DLObjDetect1'  -- 需访问的工具名
local class_name = '壳体'  -- 需检测的类别名
local required_count = 20    -- 需要累计的总数
local total_count = 0         -- 累计总数

local overlap_threshold=0.5 -- 交并比阈值

--固定ROI区域
local ROI_Region={left=2,bottom=580,right=201,top=442}

--初始化函数（初始化历史记录）
function RunScript_237fb72169744185a6a8ad1f8e491830.setup(this, ctx)
    total_count = 0
end
...
--执行函数
function RunScript_237fb72169744185a6a8ad1f8e491830.exec(this, ctx)
...
function RunScript_237fb72169744185a6a8ad1f8e491830.cleanup(this, ctx)
    total_count = 0
end

function RunScript_237fb72169744185a6a8ad1f8e491830.on_process_begin(this, ctx)
    total_count = 0
end

function RunScript_237fb72169744185a6a8ad1f8e491830.on_process_end(this, ctx)
    total_count = 0
end
