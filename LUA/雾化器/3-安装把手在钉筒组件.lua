RunScript_097d66f1eb6f42288628a1fa2b3d75b9 = {}

-- 检测凹起区域,左下、右上
local tool_name = 'DLObjDetect3'
local class_name1 = '钉筒'
local class_name2 = '把手'
local regions = {}
...
function RunScript_097d66f1eb6f42288628a1fa2b3d75b9.setup(this, ctx)

end

function RunScript_097d66f1eb6f42288628a1fa2b3d75b9.exec(this, ctx)
...
function RunScript_097d66f1eb6f42288628a1fa2b3d75b9.cleanup(this, ctx)
end

function RunScript_097d66f1eb6f42288628a1fa2b3d75b9.on_process_begin(this, ctx)
    intersections_num = 0
    regions = {}
end

function RunScript_097d66f1eb6f42288628a1fa2b3d75b9.on_process_end(this, ctx)
    intersections_num = 0
    regions = {}
end
