RunScript_143756aff22449b1b8f3470a2bb9200e = {}

-- 检测凹起区域,左下、右上
local tool_name = 'DLObjDetect11'
local class_name1 = '固定销'
local class_name2 = '销钉'
local regions = {}
...
function RunScript_143756aff22449b1b8f3470a2bb9200e.setup(this, ctx)

end

function RunScript_143756aff22449b1b8f3470a2bb9200e.exec(this, ctx)
...
function RunScript_143756aff22449b1b8f3470a2bb9200e.cleanup(this, ctx)
end

function RunScript_143756aff22449b1b8f3470a2bb9200e.on_process_begin(this, ctx)
    intersections_num = 0
    regions = {}
end

function RunScript_143756aff22449b1b8f3470a2bb9200e.on_process_end(this, ctx)
    intersections_num = 0
    regions = {}
end
