RunScript_3f8b9e962aa748c08f9a6e72417ecf8a = {}

-- 检测凹起区域,左下、右上
local tool_name = 'DLObjDetect11'
local class_name1 = '尺子'
local class_name2 = '剪刀'
local regions = {}
...
function RunScript_3f8b9e962aa748c08f9a6e72417ecf8a.setup(this, ctx)

end

function RunScript_3f8b9e962aa748c08f9a6e72417ecf8a.exec(this, ctx)
...
function RunScript_3f8b9e962aa748c08f9a6e72417ecf8a.cleanup(this, ctx)
end

function RunScript_3f8b9e962aa748c08f9a6e72417ecf8a.on_process_begin(this, ctx)
    intersections_num = 0
    regions = {}
end

function RunScript_3f8b9e962aa748c08f9a6e72417ecf8a.on_process_end(this, ctx)
    intersections_num = 0
    regions = {}
end
